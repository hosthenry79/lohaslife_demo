                  ...
                  <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a class="page-scroll" href="body">首頁</a></li>
                            <li><a class="page-scroll" href="#about-section">關於我們</a></li>
                            <li><a class="page-scroll" href="#about-section">文章</a></li>
                            <li><a class="page-scroll" href="#about-section">目錄</a></li>
                            <li><a class="page-scroll" href="#services-section">服務</a></li>
                            <li><a class="page-scroll" href="#portfolio-section">工作</a></li>
                            <li><a class="page-scroll" href="#team-section">團隊</a></li>                            
                            <li><a class="page-scroll" href="#prices-section">價格</a></li>
                            <li><a class="page-scroll" href="#contact-section">聯絡</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                  </div><!-- /.container -->
                </nav>
                                        ...
                                        <div class="row"  id="portfolio">
                                            <div class="col-xs-12 col-sm-4 appsDevelopment">
                                                <div class="portfolio_single_content">
                                                    <img src="/front/img/portfolio/p1.jpg" alt="title"/>
                                                    <div>
